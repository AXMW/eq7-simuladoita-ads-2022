...
function drawResponses(question, answer, valuesAnswers) {
	...
	var layout = {title:"<b>Porcentagem de acertos e erros da questão " + question + "</b>", plot_bgcolor: "rgba(0,0,0,0)", paper_bgcolor: "rgba(0,0,0,0)", font: { family: "Noto Sans", color: "#000000"} , showlegend: false};
